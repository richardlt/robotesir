...
import org.jarvisbotLibrary.comApi.IMessage;
import org.jarvisbotLibrary.comApi.IRawMessage;
import org.jarvisbotLibrary.comApi.JSONParser;
import org.jarvisbotLibrary.comApi.Message;
...
public class ServletRaspberry extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		IRawMessage message = null;
		try {
			message = jso.decode(JSONMessage);
